...
import 'package:personal_finance_companion_mobile_app/features/auth/presentation/cubits/auth_state.dart' as auth;
...
final _router = GoRouter(
  ...
  routes: [
    ...
    GoRoute(path: '/transactions/add', builder: (context, state) {
